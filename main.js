window.onload = function() {
    ...
    if (window.screen.width >= 640) {
        ...
        document.querySelector('.first-page') ? window.scrollTo(0, 760) : window.scrollTo(0, 170);
    }
    if (window.screen.width >= 720) {
        // mobile bg height & scroll
        document.querySelector('.first-page') ? window.scrollTo(0, 730) : window.scrollTo(0, 170);
    }
